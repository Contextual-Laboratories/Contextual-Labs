...
related:
  ...
  - engine/explanation/nexus-enrichment.md
  - engine/explanation/the-knowledge-graph.md
---
...
`engine/explanation/how-indexing-works`. None of that happens at query
...
`engine/explanation/retrieval-pipeline`), applied here directly against
...
described in `engine/explanation/the-knowledge-graph` walks outward
...
`engine/explanation/temporal-intelligence`). If the authentication code
...
`mcp-server/how-to/choose-between-search-and-nexus-search` for that more
