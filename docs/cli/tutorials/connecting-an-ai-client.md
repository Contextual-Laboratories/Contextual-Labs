...
`engine/troubleshooting/workspace-not-connecting` if the daemon itself
isn't the problem.

## See also

- `cli/reference/client`, `cli/reference/client-rm`, `cli/reference/client-list`.
- `cli/how-to/switch-or-add-a-second-ai-client`.
