...
`contextual doctor` first (see `engine/observability/interpreting-doctor-
...
- `cli/reference/index` — the next step after `init`.
- `cli/reference/doctor` — check workspace health at any time.
