...
`engine/troubleshooting/entity-not-found` for the distinction between
...
- `mcp-server/reference/graph_traverse`, `mcp-server/reference/graph_get_entity_callers`.
- `mcp-server/how-to/run-blast-radius-analysis-before-a-rename-or-delete`.
