...
a tool — check `mcp/tools/how-to/debug-a-tool-returning-zero-results`
...
`mcp/tools/explanation/tool-taxonomy` for when to reach for the graph
and temporal tools instead.

## See also

- `mcp/tools/reference/search`.
