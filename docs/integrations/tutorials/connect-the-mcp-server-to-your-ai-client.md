...
domain: integrations
category: tutorial
tldr: contextual client --<name> writes a config entry pointing your AI client at the contextual-mcp binary for the current workspace — this is the mechanism, integrations/tutorials/connecting-an-ai-client covers the command itself.
order: 1
---
...
- `integrations/tutorials/connecting-an-ai-client` — the command-line walkthrough.
- `mcp/tools/tutorials/first-grounded-query`.
