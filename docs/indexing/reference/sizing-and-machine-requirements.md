...
related:
  ...
  - indexing/reference/platform-support.md
---
...
`configuration/reference/configuration-reference`), set with real headroom
...
`indexing/reference/storage-schema-reference`). Disk usage tracks
...
Linux, and Windows. See `indexing/reference/platform-support` for
...
`indexing/how-to/size-your-machine-before-indexing-a-large-repo` and
`indexing/how-to/speed-up-or-debug-a-slow-index-run` for what to check on a
specific slow run, and `indexing/explanation/how-indexing-works` for what
