...
related:
  ...
  - retrieval/how-to/understand-stale-or-missing-results.md
---
...
always safe and cheap — see `indexing/how-to/speed-up-or-debug-a-slow-index-run`
...
`retrieval/how-to/understand-stale-or-missing-results` for how to tell the difference
